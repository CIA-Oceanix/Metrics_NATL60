...
for domain in sub_df.domain.drop_duplicates():
    ...
    GT_file               = "https://s3.eu-central-1.wasabisys.com/melody/Metrics_NATL60/Datasets/XP2/NATL60_"+domain+"_XP"+str(XP)+"_GT.nc#mode=bytes"
    OBS_file              = "https://s3.eu-central-1.wasabisys.com/melody/Metrics_NATL60/Datasets/XP2/NATL60_"+domain+"_XP"+str(XP)+"_OBS_NADIRSWOT_obs.nc#mode=bytes"
    OI_file               = "https://s3.eu-central-1.wasabisys.com/melody/Metrics_NATL60/Datasets/XP2/NATL60_"+domain+"_XP"+str(XP)+"_OI_NADIRSWOT_obs.nc#mode=bytes"
